...
public class HW3Calc2NonInherit {
...
// 1 function for each operator, passing scanner to arguments		
		...
		HW3Calc1Inheritance customObj = new HW3Calc1Inheritance (); //static to non-static
	    switch (operator) {		
	    	case '+':		
	    	...
	    	case 'x':		
	    		customObj.multiply 	(number1, number2);
		  		break;
	    	case '/':		
	    		HW3FunctionsForCalc.divide (number1, number2);	 // static to static
		  		break;
	    }
	}
}
